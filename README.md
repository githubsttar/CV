...
| Find My Pet: https://pet-hub.herokuapp.com/  | Find My Pet is a community of pet lovers where people can report or find missing pets. We taught ourselves how to split the architectures of the front and backend during development and then reconnect them on Heroku so that they become one application.  | Ruby on Rails API for the backend, React and Reactstrap for the Frontend, Base 64 for the image upload functionality. Testing was done with Cypress  |
